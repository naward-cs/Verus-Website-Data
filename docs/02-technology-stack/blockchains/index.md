# Introduction
Launch blockchains that are interconnected, customizable and independent. Each blockchain launched has the following L1 features.


| L1 Feature | Details | 
| :-----| :------ | 
| [Multi-currency](/currencies/) | Consensus layer basket currencies (e.g. liquidity pools) & simple token currencies, decentralized crowdfund mechanisms |
| [DeFi](/sendcurrency/) | Consensus layer AMMs, MEV-free, no front/back-running, solving all conversions simultaneously within a block & fully decentralized marketplace | 
| [VerusID](/verusid/) | Consensus layer self-sovereign identities, namespace for currencies, tokens & PBaaS-blockchains, friendly-name addresses, revocable, recoverable, NFTs, profiles, can be bound to any type of data | 
| Privacy | Consensus layer zk-SNARKs privacy technology |
